                        ...
                        <Layout.Section secondary>
                            <Card sectioned title="Preview your bundle">
                                <div className="bundlePreview">
                                    <div className="bundleTitle mb_2" style={{fontFamily:this.state.selectedFontFamily, fontSize: this.state.fontSize+"px", fontWeight: this.state.selectedFontType, textAlign:this.state.alignment, color: "#"+this.state.color}}>{this.state.products.bundleMessage} </div>
                                    {
